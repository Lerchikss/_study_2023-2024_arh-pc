...
Освоить процедуры компиляции и сборки программ,написанных на ассемблера NASM.
...
1.Создаем каталог, в котором создаем текстовы файл с именем hello.asm, иоткрываем его с помощью текстового редактора.
